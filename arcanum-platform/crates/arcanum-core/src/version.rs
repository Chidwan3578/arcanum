...
impl AlgorithmId {
    ...
    /// AES-128-GCM algorithm identifier.
    ...
    /// X25519 key exchange algorithm identifier.
    pub const X25519: &'static str = "X25519";
    /// ECDSA with P-256 curve algorithm identifier.
    pub const ECDSA_P256: &'static str = "ECDSA-P256";
    /// ECDSA with P-384 curve algorithm identifier.
    pub const ECDSA_P384: &'static str = "ECDSA-P384";
    /// RSA-OAEP encryption algorithm identifier.
    pub const RSA_OAEP: &'static str = "RSA-OAEP";
    /// RSA-PSS signature algorithm identifier.
    pub const RSA_PSS: &'static str = "RSA-PSS";
    /// ML-KEM-768 post-quantum KEM algorithm identifier.
    pub const ML_KEM_768: &'static str = "ML-KEM-768";
    /// ML-DSA-65 post-quantum signature algorithm identifier.
    pub const ML_DSA_65: &'static str = "ML-DSA-65";
    /// Argon2id password hashing algorithm identifier.
    pub const ARGON2ID: &'static str = "Argon2id";
    /// HKDF-SHA256 key derivation algorithm identifier.
    pub const HKDF_SHA256: &'static str = "HKDF-SHA256";
    /// BLAKE3 hash algorithm identifier.
