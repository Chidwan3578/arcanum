...
impl Sha512 {
    ...
    pub fn finalize(mut self) -> [u8; 64] {
        ...
        let bit_len_hi = self.total_len_hi
            .wrapping_mul(8)
...
mod tests {
    ...
    fn test_sha256_vs_reference() {
        ...
        for msg in test_cases {
            ...
            assert_eq!(our_hash.as_slice(), ref_hash.as_slice(), "Mismatch for: {:?}", msg);
        }
    }
    ...
    fn test_sha512_vs_reference() {
        ...
        for msg in test_cases {
            ...
            assert_eq!(our_hash.as_slice(), ref_hash.as_slice(), "SHA-512 mismatch for: {:?}", msg);
        }
    }
    ...
    fn test_sha384_vs_reference() {
        use sha2::{Sha384 as RefSha384, Digest};
        ...
        for msg in test_cases {
            ...
            assert_eq!(our_hash.as_slice(), ref_hash.as_slice(), "SHA-384 mismatch for: {:?}", msg);
        }
    }
